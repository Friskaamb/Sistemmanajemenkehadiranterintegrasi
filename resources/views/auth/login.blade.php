    ...
    <div class="bg-white w-full max-w-5xl h-[600px] rounded-3xl shadow-2xl overflow-hidden flex">
        ...
        <div class="w-full md:w-1/2 p-12 flex flex-col justify-center">
            ...
            <p class="text-gray-500 mb-8">
                Masuk ke sistem kehadiran PT.DFL
            </p>
            ...
            <form action="/login" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        class="w-full p-4 bg-gray-50 border border-gray-200 rounded-2xl outline-none focus:ring-2 focus:ring-blue-600">
                </div>
                ...
                <button
                    type="submit"
                    class="w-full bg-blue-600 text-white py-4 rounded-2xl font-bold text-lg hover:bg-blue-700 shadow-lg shadow-blue-200 transition">
                    Login
                </button>
