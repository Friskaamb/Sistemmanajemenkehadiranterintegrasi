...
<head>
    ...
    <title>Admin Dashboard - PT.DFL</title>
        ...
        <div class="max-w-7xl mx-auto px-4 flex justify-between items-center h-16">
            <div class="flex items-center gap-2">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-gray-400 uppercase tracking-widest font-bold">Admin Dashboard</p>
                </div>
            </div>
            
            <div class="hidden md:flex space-x-6 text-gray-500 font-semibold text-sm">
                <a href="/admin/dashboard" class="bg-blue-900 text-white px-4 py-2 rounded-xl flex items-center gap-2"><i class="fas fa-chart-pie"></i> Ringkasan</a>
            ...
            <div class="flex items-center gap-3">
                <div class="text-right hidden sm:block">
                    <p class="text-xs font-bold text-gray-800">Admin HR</p>
